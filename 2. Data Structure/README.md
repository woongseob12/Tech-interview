...
- 해시충돌: 서로 다른 테이터가 같은 해시 값으로 충돌나는 현상
  ...
  - 해결법
    ...
    ![image](https://user-images.githubusercontent.com/55429912/121013967-6a93d700-c7d4-11eb-84ab-36cd599465e7.png)
...
이중 해싱
ex) 1차 해시 함수 ⇒ h1(k) = k % 17
2차 해시 함수 ⇒ h2(k) = (k % c) + 1

    - 이 경우 c를 17보다 작으면서 소수인 수로 결정(쓸데 없이 몇바퀴를 추가로 돌 수 있음)
    - 2차 해시 함수에 1을 더하는 이유는 0이 나와 제자리에 저장하는 경우 방지
    - 이상적인 충돌 해결책
